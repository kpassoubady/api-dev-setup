...
Once installed, use the [quickstart-project](https://github.com/kpassoubady/api-dev-setup/tree/main/quickstart-project) to verify everything works end to end. Open it in IntelliJ or VS Code, run it with Maven, call its endpoints from Postman, and run its JUnit5 tests.
